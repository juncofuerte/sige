...
@section('content')
    <div class="container mt-12" style="width:100%" id="padre"> 
        <div class="card card-info">
            <div class="card-header">
                <h1 class="card-title"><strong>CREAR SOLICITUD</strong></h1>
            </div>
            <div class="card-body">
                ...
                <form name="frm_nsol"  method="POST" enctype="multipart/form-data" id="frm_subedoc">
                    ...
                    <div class="tab-content" id="pills-tabContent">
                        ...
                        <div class="tab-pane fade show active mt-2" id="fondos" role="tabpanel" aria-labelledby="pills-home-tab">
                            ...
                            <div class="container-fluid row mt-1">
                                <div class="col-md-6 align-self-start">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2"  id="tipocompra" name="tipocompra[]" data-placeholder="Seleccione el tipo de compra" style="width: 100%;">                                                        
                                            <option></option>
                                ...
                                <div class="col-md-6 align-self-start">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2"  id="tipofondo" name="tipofondo[]" data-placeholder="Seleccione el tipo de fondo" style="width: 100%;">                                                        
                                            <option></option>
                                            @foreach($tipofondos as $tipofondo)
                                                <option value="{{ $tipofondo->id }}+{{ $tipofondo->flag_especial }}">{{ $tipofondo->nombre }}</option>;
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="row container-fluid mt-4 justify-content-start">
                                <div class="col-md-6">
                                    <div class="container-fluid row mt-1">
                                        <div class="col-12 align-self-start">
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text">FIRMA <?php //echo strtoupper($_SESSION['unidad']);?></span>
                                        </div>
                                    </div>
                                </div>
                                </div>
                        ...
                        <div class="tab-pane fade" id="gastos" role="tabpanel" aria-labelledby="pills-profile-tab">
                            ...
                            <div id="tipfondfaep" class="row container-fluid mt-1 justify-content-start">                                                                                        
                                <div class="container-fluid row mt-1">
                                    ...
                                    <select class="form-select" size="4" id="componente" name="componente[]" aria-label="size 3 select example" style="width: 100%;">
                                    </select>
                                </div>
                                <div class="container-fluid row">
                                    <div class="col-12 align-self-start">
                                        <p>SELECCIONE LA INICIATIVA</p>
                                    </div>
                                    <select class="form-select" size="4" id="iniciativa" name="iniciativa[]" aria-label="size 3 select example" style="width: 100%;">
                                    </select>
                                </div>                                
                                <div class="container-fluid row">
                                    <div class="col-12 align-self-start">
                                        <p>DETALLE DE LA INICIATIVA</p>
                                    </div>
                                    <div id="detalleiniciativa" name="detalleiniciativa" style="height: 8em;line-height: 1,5 em;overflow-x: hidden;overflow-y: scroll;width: 100%;border: 1px solid; font-family: Arial;text-align: justify">                                        
                                    </div>
                                </div>
                                <!--REALIZACION ACTIVIDAD Y FECHA ACTIVIDAD-->
                                <div class="row container-fluid mt-1 justify-content-start">
                                ...
                                <div class="col-3">
                                    <div class="container">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="impuesto" id="iva" value="iva" checked>
                                            <label class="form-check-label" for="iva">Con IVA</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="impuesto" id="exento" value="exento">
...
@section('js')
        ...
        <script>
            $(document).ready(function() {
                ...
                //DETECTA SI HA SELECCIONADO FONDOS ESPECIALES, PARA MOSTRAR EL FORMULARIO ALTERNATIVO
                //Y DETECTA QUE SI SE HA SELECCIONADO UN FONDO SIMPLE, HABIENDO ESTADO EN UN FONDO ESPECIAL
                $("#tipofondo").data("prev",$("#tipofondo").val());
                $("#tipofondo").change(function(data){
                    var jqThis = $(this);
                    var fondoanterior=jqThis.data("prev");
                    //console.log(fondoanterior);
                    jqThis.data("prev",jqThis.val());
                    //var fondoactual=jqThis.data("prev");                    
                    console.log(fondoactual);

                    var fondoactual=$(this).val();
                    var idfondoactual=fondoactual.substr(0, fondoactual.length-2);
                    var flag_fondoactual=fondoactual.substr(fondoactual.length-1, fondoactual.length);
                    //alert('id actual: '+idfondoactual+' flag actual: '+flag_especialactual);
                    console.log('id actual: '+idfondoactual+' flag actual: '+flag_fondoactual)

                    if(fondoanterior != ''){
                        //SÍ EXISTE UNA SELECCION ANTERIOR
                        //console.log('HOLA');                        
                        //determina los parámetros de la seleccion anterior
                        var idfondoanterior=fondoanterior.substr(0, fondoanterior.length-2);
                        var flag_fondoanterior=fondoanterior.substr(fondoanterior.length-1, fondoanterior.length);
                        console.log('id anterior: '+idfondoanterior+' flag anterior: '+flag_fondoanterior);
                        //alert('id anterior: '+idfondoanterior+' flag anterior: '+flag_especialanterior);

                        //se consulta si es especial para desplegar el formulario de gastos de fondos especiales 
                        if((flag_fondoanterior==0)&&(flag_fondoactual==1)){
                            //VA DE FONDO SIMPLE A FONDO ESPECIAL
                            console.log("De simple a especial");
                            limpiaformsimple();
                            $('#tipfondotros').hide();
                            $('#tipfondfaep').show();
                            //petición al servidor de los componentes, por Ajax
                            $.get('crear/'+idfondoactual+'/componentes', function(datos){
                                console.log(datos);
                                var html_componentes='';
                                for(var i=0; i<datos.length;i++)
                                    html_componentes +='<option value="'+datos[i].id+'">'+datos[i].nombre+'</option>';
                                $('#componente').html(html_componentes);
                                $('#iniciativa').html('');
                                $('#detalleiniciativa').html('');
                            });                      
                        }else if((flag_fondoanterior==1)&&(flag_fondoactual==1)){
                            //VA DE ESPECIAL A ESPECIAL
                            console.log("De especial a especial");
                            limpiaformespecial();
                            //petición al servidor de los componentes, por Ajax
                            $.get('crear/'+idfondoactual+'/componentes', function(datos){
                                console.log(datos);
                        ...
                        }else if((flag_fondoanterior==1)&&(flag_fondoactual==0)){
                            //VA DE ESPECIAL A SIMPLE
                            console.log("De especial a simple");
                            limpiaformespecial();
                            $('#tipfondfaep').hide();
                            $('#tipfondotros').show();
                        }else if((flag_fondoanterior==0)&&(flag_fondoactual==0)){
                            //VA DE SIMPLE A SIMPLE
                            //no se hace cambio en el formulario ni contenido
                        }
                    }else{     
                        //SE ELIGE ESPCIAL COMO PRIMEA OPCION                       
                        if((flag_fondoactual==1)){
                            limpiaformsimple();
                            $('#tipfondotros').hide();
                            $('#tipfondfaep').show();
                            //petición al servidor de los componentes, por Ajax
                ...
                function limpiaformespecial(){
                    console.log('especial2');
                    $('#componente').val(null).trigger('change');
                    $('#iniciativa').val(null).trigger('change');
                    $('#detalleiniciativa').html('');
                };

                //$('#tipofondo').on('change',tipofondoSeleccionado);

                /*
                function tipofondoSeleccionado(){
                    //el value de la opcion seleccionada tiene la estructura id+flag
                    var fondo_seleccionado=$(this).val();

                    //se descompone la opcion en id y flag
                    idfondo=fondo_seleccionado.substr(0, fondo_seleccionado.length-2);
                    flag_especial=fondo_seleccionado.substr(fondo_seleccionado.length-1, fondo_seleccionado.length);
                    alert('id: '+idfondo+' flag: '+flag_especial);

                    //se consulta si es especial para desplegar el formulario de gastos de fondos especiales 
                    if(flag_especial==1){
                        //entran aquí los fondos especiales (faep, movamonos)
                        $('#descadquisicion').val('');
                        $('#area').val('');
                        $('#dimension').val('');
                        $('#actividad').val('1');
                        ...
                        //petición al servidor de los componentes, por Ajax
                        $.get('crear/'+idfondo+'/componentes', function(datos){
                            console.log(datos);
                            var html_componentes='';
                            for(var i=0; i<datos.length;i++)
                                html_componentes +='<option value="'+datos[i].id+'">'+datos[i].nombre+'</option>';
                        ...
                        //se despliega formulario con lista de componentes
                    };
                };*/

                $('#componente').on('change',componenteSeleccionado);

                function componenteSeleccionado(){
                    
                    var componente_seleccionado=$(this).val();
                    alert(componente_seleccionado);

                    //petición al servidor de los componentes, por Ajax               
                    $.get('crear/'+componente_seleccionado+'/iniciativas', function(datos){
                        console.log(datos);
                        var html_iniciativas='';
                        var html_detalle='';
                        for(var i=0; i<datos.length;i++)
                        html_iniciativas +='<option value="'+datos[i].id+'">'+datos[i].nombre+'</option>';
                        $('#iniciativa').html(html_iniciativas);
                        $('#detalleiniciativa').html('');
                        //$('#detalleiniciativa').html(html_detalle);
                    });                        
                };

                $('#iniciativa').on('change',iniciativaSeleccionado);

                function iniciativaSeleccionado(){
                    console.log('Aqui cai');
                    var iniciativa_seleccionado=$(this).val();
                    console.log('Iniciativa'+iniciativa_seleccionado);
                    if(iniciativa_seleccionado!=null){
                        //petición al servidor de los componentes, por Ajax               
                        $.get('crear/'+iniciativa_seleccionado+'/detalle', function(datos){
                            console.log('--------------------------');  
                            console.log('Datos: ->'+datos+'<-');
                            var html_detalle='';
                            if(datos[0].descripcion==null ){
                                $('#detalleiniciativa').html('Sin Detalle');
                            }else{
                                html_detalle +=datos[0].descripcion;
                                alert(html_detalle);
                                $('#detalleiniciativa').html(html_detalle);
                            };
                        });     
                ...
                */
                ...
                {
                    //recalcula el total de la fila cuando el foco sale del input txtrecargo
                    var $select = $(this);
                ...
                {
                    //recalcula el total de la fila cuando el foco sale del input txtvalnetunid
                    var $select = $(this);
                    var $row = $select.closest('tr'); //ubica la fila en la que está perdiendo el foco
                ...
                {
                    //recalcula el total de la fila cuando el foco sale del input txtcantidad
                ...
                $("#btn_subir").click(function(e)
                {
                    ...
                    */
                    ...
                    var fondoactual=$("#tipofondo").val();
                    var flag_fondoactual=fondoactual.substr(fondoactual.length-1, fondoactual.length);

                    console.log(flag_fondoactual);
                    ...
                    }else if((flag_fondoactual==0) && $("#descadquisicion").val().length<1){
                        alert("Debes ingresar una descripción de la adquisición");
                        $('#pills-tab a[href="#gastos"]').tab('show');
                        $('#gastos').tab('show');
                        $("#descadquisicion").focus();
                    }else if((flag_fondoactual==0) && $("#area").val().length<1){
                        alert("Debes ingresar un área");
                        $('#pills-tab a[href="#gastos"]').tab('show');
                        $('#gastos').tab('show');
                        $("#area").focus();
                    }else if((flag_fondoactual==0) && $("#dimension").val().length<1){
                        alert("Debes ingresar una dimensión");
                        $('#pills-tab a[href="#gastos"]').tab('show');
                        $('#gastos').tab('show');
                        $("#dimension").focus();
                    }else if((flag_fondoactual==0) && $("#actividad").val().trim() === ''){
                        alert("Debes indicar si hay o no actividad asociada");
                        $('#pills-tab a[href="#gastos"]').tab('show');
                        $('#gastos').tab('show');
                        $("#actividad").focus();
                    }else if((flag_fondoactual==0) && ($("#actividad").val()==2)&&($("#calendarioActividad").data('datepicker').getFormattedDate('dd-mm-yyyy')==='')){
                        alert("Debes seleccionar una fecha de ejecución de la actividad");
                        $('#pills-tab a[href="#gastos"]').tab('show');
                        $('#gastos').tab('show');
                        $("#calendarioActividad").focus();
                    }else if((flag_fondoactual==0) && $("#practicas").val().length<1){
                        alert("Debes ingresar las prácticas a mejorar");
                        $('#pills-tab a[href="#gastos"]').tab('show');
                        $('#gastos').tab('show');
                        $("#practicas").focus();
                    }else if((flag_fondoactual==0) && $("#resultados").val().length<1){
                        alert("Debes ingresar los resultados esperados");
                        $('#pills-tab a[href="#gastos"]').tab('show');
                        $('#gastos').tab('show');
                        $("#resultados").focus(); 
                    //}else if((flag_fondoactual==1) && $('#componente').val().length<1){
                    }else if((flag_fondoactual==1) && $('#componente').prop('selectedIndex')==-1){
                        alert("Debes ingresar información del componente");
                        $('#pills-tab a[href="#gastos"]').tab('show');
                        $('#gastos').tab('show');
                        $("#componente").focus();
                    }else if((flag_fondoactual==1) && $('#iniciativa').prop('selectedIndex')==-1){
                        alert("Debes ingresar información de la iniciativa");
                        $('#pills-tab a[href="#gastos"]').tab('show');
                        $('#gastos').tab('show');
                        $("#iniciativa").focus();
                    }else if((flag_fondoactual==1) && ($("#actividadfaep").val()==2)&&($("#calendarioActividadfaep").data('datepicker').getFormattedDate('dd-mm-yyyy')==='')){
                        alert("Debes seleccionar una fecha de ejecución de la actividad");
                        $('#pills-tab a[href="#gastos"]').tab('show');
                        $('#gastos').tab('show');
                            ...
                            success:function(respuesta1)
                            {
                                ...
                                */
                                ...
                                if(flag_fondoactual==0){
                                    ...
                                    var fondo=$("#tipofondo option:selected").text();
                                    $("#cuerpomodalresumen").append('<p align="center"><b>SOLICITUD DE GASTOS FONDO '+fondo+'<br><hr>');
                                    var compon=$("#componente option:selected").text();
                                    $("#cuerpomodalresumen").append('<b>COMPONENTE: </b>'+compon+'<br>');
                                    var inici=$("#iniciativa option:selected").text();
                                    $("#cuerpomodalresumen").append('<b>INICIATIVA: </b>'+inici+'<br>');                                    
                ...
                */
                ...
                $("input:radio").change(function () {     
                    if ($("#iva").is(":checked")) {           
                        recalculoimpuestos('iva');
                    }else{
                        recalculoimpuestos('exento');
                    }
                });
        ...
        <script>
            ...
            function recalculoimpuestos($impuesto)
            {
                // esta función recalcula el total de cada línea de artículos cuando se hace un cambio al radio impuestos
                
                //recorremos cada fila  y lo actualizamos degún el indicador con iva o exento
                console.log("entramos a recalculo funcion");
                var n=0;
                var totalfila=0;
                var t=0;
                var impuesto=0;
                ...
                {
                    cantidad= $("#tabla tbody tr:eq('"+i+"') td:eq(1) input").val();
                    valneto= $("#tabla tbody tr:eq('"+i+"') td:eq(4) input").val();
                    recargo= $("#tabla tbody tr:eq('"+i+"') td:eq(5) input").val();
                    
                    totalfila=Math.round(((cantidad*valneto)*(1+recargo/100))*(1+taza));

                    $("#tabla tbody tr:eq('"+i+"') td:eq(6) input").val(totalfila);
            ...
            function calculatotalfila($fila)
            {
                ...
                if(!test){
                    if($("input[name='impuesto']:checked").val()=='iva'){
                        impuesto=(19/100);
                    }else{
                        impuesto=0;        
                    };
                    //var iva=(19/100);
                    alert(impuesto);
                    total0=Math.round(((cant*vunit)*(1+rec/100))*(1+impuesto));
                    //console.log("test: "+test);
